                        ...
                        <div class="modal-body">
                            ...
                            <form id="form" method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <label><u>Form Data Users</u></label>
                                    <br>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tanggal_masuk" placeholder="Tanggal Masuk" class="form-controls">
                                    </div>
                                    ...
                                    {!! Form::text('name', old('name'), ['required', 'class'=>'form-control'.( $errors->has('name') ? ' form-control-danger' : '' ), 'placeholder'=>'Name Users']); !!}
                                    ...
                                    <div class="form-group">
                                    {!! Form::label('role', 'Group User', ['class'=>'control-label']); !!}

                                    {{-- Roles --}}
                                    <select class="form-control custom-select" multiple="multiple" name="role[]" id="role" data-height="100%">

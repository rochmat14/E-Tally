        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-sm-6 col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" value="{{ $users_desc->nama_depan }}" disabled>
              </div>
            </div>
            <div class="col-sm-6 col-md-6">
              <div class="form-group">
            ...
            <div class="col-sm-6 col-md-6">
              <div class="form-group">
                ...
                <input type="date" class="form-control" value="{{ $users_desc->tanggal_lahir }}" disabled>
              </div>
            </div>
            <div class="col-md-12">
              <div class="form-group">
            ...
            <div class="col-sm-6 col-md-4">
              <div class="form-group">
                ...
                <input type="text" class="form-control" value="{{ $users_desc->telp }}"  disabled>
              </div>
            </div>
          ...
          <div class="col-sm-12 col-md-12">
              <div class="form-group">
                ...
                <input type="date" class="form-control" value="{{ $users_desc->tanggal_masuk }}" disabled>
              </div>
            </div>

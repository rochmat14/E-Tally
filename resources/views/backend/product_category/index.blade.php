...
function edited(id){
    ...
    $.ajax({
        ...
        success: function(result)
        {
            ...
            $('[name="category_product"]').val(result.data.category_product);
            $('[name="description"]').val(result.data.description);
            $('#modal_form').modal('show');
            $('.modal-title').text('Edit Category Produk'); 
        },
                        ...
                        <div class="modal-body">
                            <form id="form" method="post" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="category_product" class="control-label">Category Product :</label>
                                    <input type="text" class="form-control" id="category_product" name="category_product" placeholder="Category Product">
                                </div>
                                <div class="form-group">

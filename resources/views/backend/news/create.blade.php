            ...
            <div class="panel-body tabs-menu-body">
                ...
                <div class="tab-content">
                                ...
                                @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                    <div class="tab-pane {!! $x == 0 ? 'active' : '' !!}" id="tab_content_lang_{!! $localeCode !!}">
                                        <div class="form-group">
                                            <label for="title_{!! $localeCode !!}"  class="control-label col-lg-2">{{ __('main.title') }} {!! $localeCode !!}<span class="required">*</span></label>
                                            <div class="col-lg-12">
                                                <input type="text" class="form-control" id="title_{!! $localeCode !!}" name="title[{!! $localeCode !!}]" value="{{ old('title.'.$localeCode) }}" required="" maxlength="255">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-12">
                                                <textarea class="form-control" id="description_{!! $localeCode !!}" name="description[{!! $localeCode !!}]">{{ old('description.'.$localeCode) }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <?php $x++ ?>
                    ...
                    <div style="padding-top: 20px;">
                        ...
                        <a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(),URL::to( 'admin/'.$controller )) }}" class="btn btn-white btn-default">{{ __('main.cancel') }}</a>
                    </div>

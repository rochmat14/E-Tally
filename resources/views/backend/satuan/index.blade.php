...
function edited(id){
    ...
    $.ajax({
        ...
        success: function(result)
        {
            ...
            $('[name="satuan_name"]').val(result.data.satuan_name);
                        ...
                        <div class="modal-body">
                            <form id="form" method="post" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="satuan_name" class="control-label">Satuan :</label>
                                    <input type="text" class="form-control" id="satuan_name" name="satuan_name" placeholder="Satuan">
                                </div>
                                <div class="form-group">

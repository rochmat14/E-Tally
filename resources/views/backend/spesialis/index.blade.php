...
$(document).ready(function() {
    ...
    @if(auth()->user()->can($controller.'-create'))
        $("div.custom-toolbar").html('<button class="btn btn-success waves-effect waves-light" onclick="add()"><i class="glyphicon glyphicon-plus"></i>Create Jenis Spesialis</button> <button class="btn waves-effect waves-light btn-secondary" onclick="reload_table()"><i class="glyphicon glyphicon-refresh"></i> Reload</button>');
    @endif
...
function add() {
    ...
    $('#photo-preview').hide();
    $('.modal-title').text('Add Jenis Spesialis');
    // event.preventDefault();
}
...
function edited(id){
    ...
    $.ajax({
        ...
        success: function(result)
        {
            ...
            $('[name="nama_spesialis"]').val(result.data.nama_spesialis);
            $('[name="description"]').val(result.data.description);
            $('#modal_form').modal('show');
            $('.modal-title').text('Jenis Spesialis Edit'); 
        },
                    ...
                    <div class="modal-body">
                        <form id="form" method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <label for="name" class="control-label">Nama Spesialis :</label>

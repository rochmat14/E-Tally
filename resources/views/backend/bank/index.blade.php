...
$(document).ready(function() {
    $.ajaxSetup({
        ...
        columns: [
            ...
            { data: 'bank_rekening', name: 'bank_rekening'},
        ...
        "columnDefs": [
            ...
            },
            {
                ...
                "render": function ( data, type, row ) {
                    var bank_logo = row['bank_logo'];
                    return `
                            <img src="{{ asset('/images/bank/') }}/${bank_logo}">
                    `;  
    ...
    @if(auth()->user()->can($controller.'-create'))
        $("div.custom-toolbar").html('<button class="btn btn-success waves-effect waves-light" onclick="add()"><i class="glyphicon glyphicon-plus"></i>Create Bank</button> <button class="btn waves-effect waves-light btn-secondary" onclick="reload_table()"><i class="glyphicon glyphicon-refresh"></i> Reload</button>');
    @endif
                ...
                <div class="modal-content modal-content-demo">
                    ...
                    <div class="modal-body">
                        <form id="form" method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="name" class="control-label">Bank Rekening:</label>
                                <input type="text" class="form-control" id="bank_rekening" name="bank_rekening" placeholder="Bank Rekening">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="name" class="control-label">Bank Logo:</label>
                                <input type="file" class="form-control" id="bank_logo" name="bank_logo" placeholder="Bank Logo">
                            </div>
                        </form>
                    </div>

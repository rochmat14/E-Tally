...
@section('content')
    ...
    <form method="POST" action="/dashboard/ship-agent" id="form-shipt-agent">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_perusahaan" class="form-control nama-perusahaan-input">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="telp" class="form-control telp-input">
                        </div>
                    </div>

...
@section('js_scripts')
    <script type="text/javascript">
        // validasi form admin
        $('form#form-shipt-agent').on('submit', function(event) {
...
<form method="POST" action="/dashboard/ship-agent/{{ $ship_agent->id }}" id="form-shipt-agent">
    <div class="card card-custom">
        <div class="card-header">
            <span class="font-weight-bold">Ship Agent</span>
        </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ $ship_agent->nama_perusahaan }}" name="nama_perusahaan" class="form-control nama-perusahaan-input">
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ $ship_agent->telp }}" name="telp" class="form-control telp-input">
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ $ship_agent->alamat }}" name="alamat" class="form-control alamat-input">
                    </div>
                </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ $ship_agent->email }}" name="email" class="form-control email-input">
                    </div>
                </div>
            </div>

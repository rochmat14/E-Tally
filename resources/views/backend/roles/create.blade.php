                ...
                <div class="row">
                    <div class="col-md-12 ">
                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }} ">
                            ...
                            {!! Form::text('name', old('name'), ['required', 'class'=>'form-control'.( $errors->has('name') ? ' form-control-danger' : '' ) ]); !!}
                    ...
                    <div class="col-md-12 ">
                        <div class="form-group{{ $errors->has('deskripsi') ? ' has-danger' : '' }} ">
                            ...
                            {!! Form::text('deskripsi', old('deskripsi'), ['required', 'class'=>'form-control'.( $errors->has('deskripsi') ? ' form-control-danger' : '' ) ]); !!}

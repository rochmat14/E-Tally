                        ...
                        <div class="modal-body">
                            <form id="form" method="post" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Nama Certificate">
                                </div>
                                <div class="form-group">
                                    <label for="image" class="control-label">Image Certificate:</label>
                                    <input type="file" class="form-control" id="image" name="image" placeholder="Logo Client">
                                </div>
                            </form>
                        </div>

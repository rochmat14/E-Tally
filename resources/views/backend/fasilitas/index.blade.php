...
$(document).ready(function() {
        ...
        "columnDefs": [
            ...
            },
            {
                ...
                "render": function ( data, type, row ) {
                    ...
                    return `
                            <img src="{{ asset('/images/fasilitas/') }}/${file_image}">
                    `;  
    ...
    @if(auth()->user()->can($controller.'-create'))
        $("div.custom-toolbar").html('<a href="{{ url('dashboard/fasilitas/create') }}" class="btn btn-success waves-effect waves-light"><i class="glyphicon glyphicon-plus"></i>Add Fasilitas</a> <button class="btn waves-effect waves-light btn-secondary" onclick="reload_table()"><i class="glyphicon glyphicon-refresh"></i> Reload</button>');
    @endif
...
<div class="page-header">
  ...
  <div class="page-rightheader ml-auto d-lg-flex d-none">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="#">Data Fasilitas</a></li>

...
class ProcessBookingEmail extends Mailable
{
    ...
    public function build()
    {
        ...
        $subject="Informasi Pemesanan ".$data_param['type_booking']." | INB Logisitik";

        return $this->view('email.email_proses_booking', compact('return_data','data_service','data_bank'))->subject($subject);
    }
}
